...
<main>
    <!-- App Bar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top ml-5 mr-5">
      <a class="navbar-brand" href="/#">
        <img src="/img/logo2.png" width=64 height=64 alt="Le Café La Planck">
      </a>
      <button
        ...
        <span class="navbar-text ms-auto">
          <ul class="navbar-nav float-right">
            ...
            <li class="nav-item ms-auto">
              <a class="nav-link" href="/#" on:click="{logout}">Déconnexion</a>
            </li>
            {:else}
            <li class="nav-item ms-auto">
              <a class="nav-link" href="/#" on:click="{login}">Connexion</a>
            </li>
            {/if}
          </ul>
        </span>
